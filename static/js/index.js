...
function loadGlobalData() {
    ...
    global_paper_field.find(d => d.id == fields.length-1).num = global_nodes.filter(d=> d.topic==fields.length-1).length;
...
function probToOpacity(prob, a=0) {
